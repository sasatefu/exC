...
-- Q	=>  Location: PIN_B4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- clock	=>  Location: PIN_P2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF GEN1KHz IS
...
SIGNAL CNT1ms : std_logic_vector(14 DOWNTO 0);
...
-- Equation(s):
-- \Add0~28_combout\ = \Add0~27\ $ (!CNT1ms(14))
...
PORT MAP (
	...
	datain => \CNT1ms~5_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => CNT1ms(14));

-- Location: LCCOMB_X2_Y35_N24
\CNT1ms~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \CNT1ms~5_combout\ = (\Add0~28_combout\ & (((!\Equal0~3_combout\) # (!\Equal0~0_combout\)) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!CNT1ms(3) & (CNT1ms(2) & (CNT1ms(0) & CNT1ms(1))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!CNT1ms(4) & (CNT1ms(7) & (CNT1ms(5) & !CNT1ms(6))))
...
-- Equation(s):
-- \CNT1ms~0_combout\ = (\Add0~6_combout\ & (((!\Equal0~0_combout\) # (!\Equal0~3_combout\)) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \CNT1ms~1_combout\ = (\Add0~10_combout\ & (((!\Equal0~3_combout\) # (!\Equal0~0_combout\)) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \CNT1ms~2_combout\ = (\Add0~14_combout\ & (((!\Equal0~3_combout\) # (!\Equal0~0_combout\)) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \CNT1ms~3_combout\ = (\Add0~16_combout\ & (((!\Equal0~3_combout\) # (!\Equal0~0_combout\)) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \CNT1ms~4_combout\ = (\Add0~26_combout\ & (((!\Equal0~3_combout\) # (!\Equal0~0_combout\)) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \Equal0~2_combout\ = (CNT1ms(8) & (!CNT1ms(11) & (!CNT1ms(10) & !CNT1ms(9))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (CNT1ms(14) & (!CNT1ms(12) & (CNT1ms(13) & \Equal0~2_combout\)))
...
-- Equation(s):
-- \o~0_combout\ = \o~regout\ $ (((\Equal0~1_combout\ & (\Equal0~0_combout\ & \Equal0~3_combout\))))
